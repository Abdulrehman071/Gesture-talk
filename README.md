# Gesture-talk
This is a Python Computer Vision project. It uses your webcam to recognize hand gestures and convert them into speech.
GestaTalk v4.1 🤲
Real-time Hand Gesture to Speech — Python + MediaPipe + OpenCV

Detects 25 hand gestures (14 single-hand + 11 two-hand combos) via webcam, displays live captions on screen, and speaks them aloud in a male voice.
